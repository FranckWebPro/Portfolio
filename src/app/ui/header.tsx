    ...
    <header className="animate-blur fixed z-50 mx-auto h-16 w-full md:h-20">
      <nav className="mx-auto flex h-16 max-w-screen-2xl items-center justify-between">
        ...
        <div className="flex items-center gap-4 sm:flex">
          <a
            className="bg-secondaryColor text-darkColor hover:bg-secondaryLight hover:text-lightColor rounded-lg px-6 py-3 text-sm font-semibold shadow duration-300 2xl:text-base"
            href="#contact"
          >
            Contactez moi
          </a>
